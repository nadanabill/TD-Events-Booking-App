...
part of 'event_details_api_service.dart';
...
class _EventDetailsApiService implements EventDetailsApiService {
  _EventDetailsApiService(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  }) {
    baseUrl ??= 'http://api.td-dev.turndigital.net/api/';
  }
